...
#include <klocale.h>
/****************************************************************************
** Form implementation generated from reading ui file '/home/serg/proj/tmp2/kdiffext/setup/src/general_base.ui'
**
...
/*
 *  Constructs a GENERAL_BASE as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 */
GENERAL_BASE::GENERAL_BASE( QWidget* parent, const char* name, WFlags fl )
    : QWidget( parent, name, fl )
{
    if ( !name )
	setName( "GENERAL_BASE" );
    GENERAL_BASELayout = new QGridLayout( this, 1, 1, 11, 6, "GENERAL_BASELayout"); 
    spacer17 = new QSpacerItem( 20, 20, QSizePolicy::Expanding, QSizePolicy::Minimum );
    GENERAL_BASELayout->addItem( spacer17, 0, 1 );
    spacer3_2_2 = new QSpacerItem( 20, 16, QSizePolicy::Minimum, QSizePolicy::Expanding );
    GENERAL_BASELayout->addItem( spacer3_2_2, 1, 1 );
    ...
    GENERAL_BASELayout->addWidget( kcfg_max_filename_length, 0, 0 );
    languageChange();
 ...
 *  language.
 */
void GENERAL_BASE::languageChange()
{
